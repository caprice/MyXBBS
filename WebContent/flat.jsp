		...
		<center>
			<div class="wrapper">
				...
				<div class="menu">
					...
					<div class="menu-text">
						&nbsp;&nbsp;
						<a href="about.do" class="nav">关于</a>
					</div>
					<div class="menu-text">
						&nbsp;&nbsp;
											...
											<tr>
												...
												<td align="right">
													<span class="STYLE3"><span class="STYLE5">浏览${hit
														...
														style="BORDER-RIGHT: #aaaadd 1px solid; PADDING-RIGHT: 3px; BORDER-TOP: #aaaadd 1px solid; PADDING-LEFT: 3px; PADDING-BOTTOM: 0.5px; MARGIN: 1px; BORDER-LEFT: #aaaadd 1px solid; COLOR: #006699; PADDING-TOP: 1px; BORDER-BOTTOM: #aaaadd 1px solid; TEXT-DECORATION: none; font-size: 12px"
														href="plat.do?pageNo=${pageNo-1 }">&larr; 上一页</A> <c:choose>
														...
														style="BORDER-RIGHT: #aaaadd 1px solid; PADDING-RIGHT: 3px; BORDER-TOP: #aaaadd 1px solid; PADDING-LEFT: 3px; PADDING-BOTTOM: 0.5px; MARGIN: 1px; BORDER-LEFT: #aaaadd 1px solid; COLOR: #006699; PADDING-TOP: 1px; BORDER-BOTTOM: #aaaadd 1px solid; TEXT-DECORATION: none; font-size: 12px"
														href="plat.do?pageNo=${pageNo+1 }">下一页 &rarr;</A> </span>
												</td>
											</tr>
										</table>
									</td>
																		...
																		<c:choose>
																			<c:when test="${i mod 2 == 1}">
																				<tr>
																					...
																					<td align="center">
																						<a href="flatdetail.do?id=${a.id }">查看</a>
																					</td>
																				</tr>
																			</c:when>
																			<c:otherwise>
										...
										<table align="right">
											<tr align="right">
												<td align="right">
													...
													<A
														style="BORDER-RIGHT: #aaaadd 1px solid; PADDING-RIGHT: 3px; BORDER-TOP: #aaaadd 1px solid; PADDING-LEFT: 3px; PADDING-BOTTOM: 0.5px; MARGIN: 1px; BORDER-LEFT: #aaaadd 1px solid; COLOR: #006699; PADDING-TOP: 1px; BORDER-BOTTOM: #aaaadd 1px solid; TEXT-DECORATION: none; font-size: 12px"
														href="plat.do?pageNo=${pageNo-1 }">&larr; 上一页</A>
													...
													<A
														style="BORDER-RIGHT: #aaaadd 1px solid; PADDING-RIGHT: 3px; BORDER-TOP: #aaaadd 1px solid; PADDING-LEFT: 3px; PADDING-BOTTOM: 0.5px; MARGIN: 1px; BORDER-LEFT: #aaaadd 1px solid; COLOR: #006699; PADDING-TOP: 1px; BORDER-BOTTOM: #aaaadd 1px solid; TEXT-DECORATION: none; font-size: 12px"
														href="plat.do?pageNo=${pageNo+1 }">下一页 &rarr;</A>
												</td>
											</tr>
										</table>

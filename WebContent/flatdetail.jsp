			...
			<div class="wrapper">
				...
				<div class="menu">
					...
					<div class="menu-text" style="padding-right: 30px;">
						<a href="index.do" class="nav">树形结构</a>
					</div>
					<div class="menu-text">
						&nbsp;&nbsp;
					...
					<div class="menu-text">
						&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="post.do" class="nav"><b>发表新帖</b> </a>
					</div>
											...
											<tr>
												<td align="right">
													<span class="STYLE3"><span class="STYLE5"></span>&nbsp;&nbsp;&nbsp;&nbsp;<A
														...
														style="BORDER-RIGHT: #aaaadd 1px solid; PADDING-RIGHT: 3px; BORDER-TOP: #aaaadd 1px solid; PADDING-LEFT: 3px; PADDING-BOTTOM: 0.5px; MARGIN: 1px; BORDER-LEFT: #aaaadd 1px solid; COLOR: #006699; PADDING-TOP: 1px; BORDER-BOTTOM: #aaaadd 1px solid; TEXT-DECORATION: none; font-size: 12px"
														href="flatdetail.do?pageNo=${pageNo+1 }&id=${id }">下一页
															&rarr;</A> </span>
												</td>
											</tr>
										</table>
																		...
																		<tr>
																			<td width="21%" bgcolor="#dee3e7">
																				<table width="90%" height="227" border="0"
																					...
																					<tr align="left">
																						<td>
																							<span class="STYLE3"><strong>等级：${u.currentBbs.user.level
																									}级</strong> </span>
																						</td>
																					</tr>
																					<tr align="left">
																					...
																					<tr align="left">
																						<td>
																							<span class="STYLE3">发帖：${u.currentBbs.user.appearNum
																								}</span>
																						</td>
																					</tr>
																					<tr align="left">
																						<td>
																							<span class="STYLE3">积分：${u.currentBbs.user.score
																								}</span>
																						</td>
																					</tr>
																					<tr align="center">
																						<td>
																							<span class="STYLE3">第${i }楼</span>
																						</td>
																					</tr>
																				</table>
																			</td>
																			<td width="79%">
																				<table width="100%" height="100%" border="0">
																					<tr>
																						<td height="27">
																							&nbsp;&nbsp;
																							<span class="STYLE3">发表时间：${u.currentBbs.pdate
																								}<br />&nbsp;&nbsp;------------------------------------------------------------</span>
																						</td>
																					</tr>
																		...
																		<tr>
																			...
																			<td width="79%" align="center">
																				<span class="STYLE3"><img
																					...
																					href="reply.do?id=${u.currentBbs.id }">回复该贴</a> </span>
																			</td>
																		</tr>
																	</table>
																</td>
